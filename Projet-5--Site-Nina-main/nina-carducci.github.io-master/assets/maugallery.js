...
boutonDroit.addEventListener("click", imageSuivante);
boutonGauche.addEventListener("click", imagePrecedente);
...
// Assurez-vous que "imagesContainer" est défini quelque part dans votre code
